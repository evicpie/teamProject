...
<link href="${conPath }/css/mainHeader.css" rel="stylesheet" type="text/css">
<script>
  	$(document).ready(function(){
  		...
  		var defineHeaderLeft = function() {
  			...
  			if(document.body.clientWidth>1820){ // 화면 너비가 1820보다 크면 
  				left = (document.body.clientWidth-1820)/2; // 헤더가 중앙에 오도록 left값 계산
  			} else { // 화면 너비가 1820보다 작거나 같으면
  				left = (1890-1820)/2; // left값을 35px로 유지
  			}
