...
<link href="${conPath }/css/remoteMain.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<!-- 호텔예약(지도)/공지사항/고객센터(문의글작성)/이벤트/메뉴버튼 --><!-- 호텔사이트전체소개(로고에) -->
		...
		<div id="button4"><!-- 예약버튼(지도) -->
			<a href="#area1"><img src="${conPath }/img/remoteReserve.png" id="remoteReseve" onmouseover="remoteBtn4(1);" onmouseout="remoteBtn4(0);"/></a>		
		</div>
